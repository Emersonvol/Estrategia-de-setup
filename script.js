...
let novoNome = nomesTime.filter((este,i)=>{//filtra se a nomes reptidos 
    return nomesTime.indexOf(este)=== i;
  }).join('<br>');//join para dar troca virgula por quebra de linha
...
const tempoPadrao = {'OP 50':"2:00",'OP 40':"3:00",'OP 230¹':"5:00",'OP 230²':"5:00",'OP 240':"4:30"
...
function preparadoaMaquinas(nomesTime,preparador) {
  ...
  novoSelect2.options[0] = new Option('Selecione-Preparador', '');
